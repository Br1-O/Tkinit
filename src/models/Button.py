...
class Button(Widget):
    ...
    def create(cls, window, **kwargs):
        """
        Creates an instance of the Button widget with the specified options.

        Parameters:
            **window** (tk.Tk | tk.Toplevel): The parent window.

        === General Options ===
            **text** (str): The label shown on the button. Default: "".
            ...
            **command** (callable): Function to call when the button is clicked. Default: None.
